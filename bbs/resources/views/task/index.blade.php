...
<table>
    ...
    <td>
    	<form  style="float:left; margin-right:10px;" action="task/create" method="GET">
    	...
    	<form action="/task" method="GET" style="float:left;">
...
<a href = "/task?pageNum={{ $startPage }}"><<</a>
    <?php if($pageNum == 1)
    {
    echo "";
    }
    ...
    { ?>
    <a href = "/task?page={{ $pageNum-1 }}"><</a>
<?php } ?>
    <?php for($i=$startPage; $i<=$endPage; $i++)
    { ?>
    <a href = "/task?page=<?= $i ?>"><?= $i ?></a>
<?php } ?>
